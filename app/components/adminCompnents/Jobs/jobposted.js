      ...
      <div className="p-5 bg-white shadow-md rounded-lg w-[70%] m-5">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <div className="flex p-3 font-semibold">
            ...
            <div className="w-1/6 text-[#858585] text-xs leading-5 font-semibold">Employeer ID</div>
            <div className="w-1/6 text-[#858585] text-xs leading-5 font-semibold">Employeer Name</div>
          ...
          {jobSeekers.length > 0 &&
            jobSeekers.map((seeker, index) => (
              <div
                key={index}
                className="flex p-3 border border-[#F0F0F0] rounded-md bg-white h-16 items-center"
              >
